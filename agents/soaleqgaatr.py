...
class SOAleqgAATr(Agent):
    ...
    def store_terminal_state(self, state, reward) -> None:
        ...
        self.next_aat_state = self._create_aat_vec(self.generator_to_use_idx)
    ...
    def act(self, state, reward, round_num):
        ...
        self.aat_state = self.next_aat_state if self.next_aat_state is not None else self._create_aat_vec(0)
